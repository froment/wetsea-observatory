...
> **Auto-généré** par `scripts/build_master.sh` · Last update : 2026-05-13T11:43:46Z
...
- **[`brand_guidelines.md`](#source-brand_guidelines-md)** — WetAndSeaAI / WetSeaTech — Brand Guidelines
...
- **[`prompts/master_prompt.md`](#source-prompts-master_prompt-md)** — Prompt Maître — WetAndSeaAI / WetSeaTech
- **[`prompts/youtube_thumbnail_prompt.md`](#source-prompts-youtube_thumbnail_prompt-md)** — YouTube Thumbnail Prompt
...
- **[`system_prompt.md`](#source-system_prompt-md)** — WetAndSeaAI / WetSeaTech — System Prompt
...
## Global Prompt
Use `system_prompt.md` as baseline.

## Channel Prompts
- YouTube: apply `prompts/youtube_thumbnail_prompt.md`.
- Mascot: apply `prompts/mascot_prompt.md`.
- General illustration: apply `prompts/master_prompt.md`.
...
## Hierarchy
- H1: high contrast serif, tight tracking.
- H2/H3: restrained sans with spacing rhythm.
- Metadata: monospace optional for coordinates/time stamps.

## Rules
- Avoid novelty or futuristic fonts.
...
Generate a cinematic editorial thumbnail for WetSea Observatory.

## Objectives
- Communicate technical exploration of maritime/global systems.
- Remain legible at small sizes.
- Maintain premium restraint.

## Layout
- One dominant subject.
- One short headline (3–6 words).
- One technical sublabel.
- Clean margins, no clutter.

## Forbidden
- Clickbait arrows/faces.
- Neon typography.
- Excessive contrast pumping.
